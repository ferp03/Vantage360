...
test.describe('Pruebas Automatizadas de Regresión', () => {
  test('HU13.CA5 - Visibilidad del proyecto para usuarios', async ({ page }) => {
    ...
    // Verificar que aparece la sección "Proyectos disponibles"
    await expect(page.locator('text=Proyectos disponibles:')).toBeVisible();
  });
});